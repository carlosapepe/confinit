 ...
 * CONFINIT Simulation
 *
 * Author: Csrlos Alberto Pedroso Junior (capjunior@inf.ufpr.br)
 *
...
using namespace std;
 ...
 int main (int argc, char **argv)
 {
   ...
   mobility.SetPositionAllocator ("ns3::GridPositionAllocator",
                                  ...
                                  "GridWidth", UintegerValue (5), //linha vertical 
  ...
  /////////////////////////////////////////////////////////////
   ...
   lrWpanHelper.EnableAsciiAll (ascii.CreateFileStream ("test2.tr"));
   lrWpanHelper.EnablePcapAll (std::string ("test2"), true);
