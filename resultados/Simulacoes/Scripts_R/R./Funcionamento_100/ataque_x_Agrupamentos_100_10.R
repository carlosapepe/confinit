...
#ENTRADA DOS DADOS
dados_10 <- read.delim("/home/carlos/Documentos/Mestrado2019/Sbseg2019/Simulacoes/100nos/dados_100_10.txt", header = TRUE, sep="\t")
...
p <- plot_ly(x = dados_10$time, y = dados_10$ch, name = 'DDFC',
  ...
  layout(xaxis = eixo_x_1, yaxis = eixo_y_1, 
         #title = "(h) 100 nós 10% de atacantes", # chart title
