...
#ENTRADA DOS DADOS
dados_05 <- read.delim("/home/carlos/Documentos/Mestrado2019/Sbseg2019/Simulacoes/75nos/dados_75_5.txt", header = TRUE, sep="\t")
...
p <- plot_ly(x = dados_05$time, y = dados_05$ch, name = 'DDFC',
  ...
  layout(xaxis = eixo_x_1, yaxis = eixo_y_1, 
         title = "(e) 75 nós 5% de atacantes", # chart title
