...
#ENTRADA DOS DADOS
dados_02 <- read.delim("/home/carlos/Documentos/Mestrado2019/Sbseg2019/Simulacoes/75nos/dados_75_2.txt", header = TRUE, sep="\t")
...
p <- plot_ly(x = dados_02$time, y = dados_02$ch, name = 'DDFC',
  ...
  layout(xaxis = eixo_x_1, yaxis = eixo_y_1, 
         title = "(d) 75 nós 2% de atacantes", # chart title
