...
rede <- c("2%", "5%", "10%")
ataq_10 <- c(3.2,3.4,3.6)
ataq_20 <- c(3.1,3.2,3.4)
ataq_30 <- c(2.8,2.9,3)
...
p <- plot_ly(data, x =~factor(rede), y = ~ataq_10,
             ...
             type = 'bar', marker = list(color = 'rgb(1.0,0.03,0.0)'), #'rgb(0.0,0.5,0.0)'
             #marker = list(colors = colors),
             name = '50_nós') %>%
  add_trace(y = ~ataq_20, name = '75_nós', 
            marker = list(color = 'rgb(0.0,0.5,0.0)')) %>% #'rgb(0.0,0.0,1.0)'
  add_trace(y = ~ataq_30, name = '100_nós', 
            marker = list(color = 'rgb(0.0,0.0,1.0)')) %>% #'rgb(1.0,0.03,0.0)'
